...
//    }
    ...
    public ArrayList<Question> getQuestionByQuizId(int quizId) {
        ...
        try {
            String sql = "SELECT Question.*, QuizLevel.[Name]\n" +
"                    FROM     Question INNER JOIN\n" +
"                                     QuizLevel ON Question.QuizlevelId = QuizLevel.Id\n" +
"                    			  where Question.QuizId = ? and StatusId = 1  ";
            ...
            while (rs.next()) {
                ...
                ql.setId(rs.getInt("QuizlevelId"));
                ql.setLevelName(rs.getString("Name"));

                OptionDBContext odb = new OptionDBContext();
                ArrayList<Option> options = odb.getOptionByQuestionId(q.getId());
